...
void init_ds1307(void)
{
    ...
    // to change hour
    // dummy = read_ds1307(HOUR_ADDR);
    // write_ds1307(HOUR_ADDR, (dummy & 0xE0)| (dummy | 0x24)); 
    ...
    // sec
    // dummy = read_ds1307(SEC_ADDR);
    // write_ds1307(SEC_ADDR, (dummy &0x80) | 0x55);
...
void write_ds1307(unsigned char address, unsigned char data) // controller to rtc
{
	i2c_start();
